...
class KruskalVisualization:
    ...
    def visualize_step(self, sorted_edges, current_step):
        ...
        if self.current_edge:
            ...
            nx.draw_networkx_edges(current_graph, pos, edge_color='red', width=2, style='dashed')
        ...
        current_edge_info = ""
        if self.current_edge:
            status = "ADICIONADA" if self.current_edge[:2] in [(e[0], e[1]) for e in self.mst_edges] else "REJEITADA"
    ...
    def create_final_visualization(self, mst, total_weight):
        ...
        # Desenha todas as arestas em cinza claro
        nx.draw_networkx_edges(G, pos, edge_color='lightgray', width=1, alpha=0.3)
        ...
        nx.draw_networkx_edges(mst_graph, pos, edge_color='green', width=4)
